...
#include <version.h> // File should be generated by make file to get the
// version.h of the current active kernel version.
...
/**
 * Kernel Version supports `pin_user_pages`, if not, `get_user_pages` must be
 * used
 */
#define KERNL_SUPPORTS_PIN_UG (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 6, 0))
